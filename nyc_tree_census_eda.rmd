...
```{r echo=FALSE}
# Add this to a plot to drop axes/ticks but keep legend. From linked S/O post
...
```{r echo=FALSE}
communities<-readOGR("Shapefiles/geo_export_1a16a8c9-efbb-4d27-82b6-d0d4928d183e.shp",
                     layer="geo_export_1a16a8c9-efbb-4d27-82b6-d0d4928d183e")
...
rockaway_trees <- subset(trees, cb_num == 414 & status == 'Alive')
